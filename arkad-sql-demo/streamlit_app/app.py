...
if 'agent_executor' not in st.session_state:
    st.session_state["llm"] = ChatOpenAI(temperature=0, model="gpt-4-0125-preview", streaming=True, model_kwargs={"seed": 123})
    # st.session_state["llm"] = ChatOpenAI(temperature=0, model="gpt-4", streaming=True, model_kwargs={"seed": 123})
    # st.session_state["llm"] = ChatOllama(model="mistral:instruct", model_kwargs={"seed": 123})
